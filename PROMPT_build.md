...
3. Note the PR URL in `progress.md`
...
2. Append to `progress.md` using this template:
   ```
   ## Task [N] - [Timestamp]
   ### Completed: [Task Name]
   - What was implemented
   ...
   ---
   ```
3. If this was the last task in a phase, note it in `progress.md` for final review
